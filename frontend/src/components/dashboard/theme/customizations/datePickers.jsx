  ...
  MuiPickersMonth: {
    styleOverrides: {
      monthButton: ({ theme }) => ({
        ...
        [`&.${pickersCalendarHeaderClasses.selected}`]: {
        ...
        '&:focus': {
          ...
          outlineOffset: '2px',
          backgroundColor: 'transparent',
          [`&.${pickersCalendarHeaderClasses.selected}`]: { backgroundColor: gray[700] },
        },
        ...theme.applyStyles('dark', {
          ...
          '&:focus': {
            ...
            outlineOffset: '2px',
            backgroundColor: 'transparent',
            [`&.${pickersCalendarHeaderClasses.selected}`]: { backgroundColor: gray[300] },
          },
        }),
      }),
    },
